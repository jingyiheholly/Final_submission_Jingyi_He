...
FOLDER = 'VLM_Seminar25_Dataset/chest_xrays'
...
CSV_OUTPUT_PATH = "maira_all_predictions_44.csv"
...
with open(csv_path, mode="w", newline='', encoding="utf-8") as f:
    ...
    for filename in os.listdir(IMAGES_PATH):
        if filename.endswith(".png"):
            ...
            try:
                eva_data_list,gt_label_list = get_eva_data(IMAGES_PATH, img_id,ground_truth)
    ...
    # Append each box and its corresponding class id
                                for box in boxes:
